...
//     });
// });
// // Function to display words one by one for the first line
...
//             index1++;
//             setTimeout(displayNextWord1, 400); // Adjust speed here (in milliseconds)
//         }
//     }
//     displayNextWord1();
// }
...
// // FUNCTION TO CREATE ANIMATION IN ABOUT US SECTION
//     setTimeout(() => {
...
//     const educationTabButton = document.querySelector('.tab-button:nth-child(2)'); // Assuming it's the second button
//     const educationItems = document.querySelectorAll('.education-item');
//     let currentIndex = 0;

//     // Function to show the current education item
//     function showEducationItem(index) {
...
//     showEducationItem(currentIndex);

//     // Event listener for the Education tab button
//     educationTabButton.addEventListener('click', function () {
//         currentIndex = 0; // Reset index when tab is clicked
//         showEducationItem(currentIndex); // Show the first education item
//         setInterval(() => {
//             currentIndex = (currentIndex + 1) % educationItems.length; // Loop through items
//             showEducationItem(currentIndex); // Show next item
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Your JavaScript code, including event listeners
});
